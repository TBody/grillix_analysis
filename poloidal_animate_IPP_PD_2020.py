...
class PoloidalAnimateCLI(BaseCLI):
    ...
    def __init__(self, parse=False, display=False):
        super().__init__("Animate values over a poloidal plane for IPP Program Day 2020")
